...
interface ConversationsContextType {
    ...
    addConversation: (targetEmail: string, creatorId: number) => Promise<UserAndConversation | undefined>;
    addConversationForAdmin: (user: User) => Promise<void>;
...
export function ConversationsProvider({ children }: { children: ReactNode }) {
    ...
    const addConversationForAdmin = async (user: User) => {
